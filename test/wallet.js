...
describe('Wallet', () => {
  ...
  describe('exportPrivateKeys', () => {
    it('works', async () => {
      ...
      await wallet.load();
      // eslint-disable-next-line max-len
      const expected = '[110,98,64,238,24,71,230,185,181,63,168,98,46,14,127,90,156,52,127,24,25,203,192,134,5,221,222,80,31,9,220,36,64,64,212,250,35,108,209,10,218,1,46,84,224,240,6,213,34,115,59,239,114,66,86,239,198,11,59,136,219,91,47,233]';
